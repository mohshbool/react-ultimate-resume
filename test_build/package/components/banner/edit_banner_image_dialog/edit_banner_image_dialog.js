...
var EditBannerImageDialogComponent = function EditBannerImageDialogComponent(_ref2) {
  ...
  var hasUnsplashEndpoint = (0, _react.useMemo)(function () {
    return !!endpoints.unsplashProxy;
  }, [endpoints.unsplashProxy]);
  var needsFailoverField = (0, _react.useMemo)(function () {
  ...
  var onImageChanged = (0, _react.useCallback)(function (payload) {
    onChange(payload);
  }, [onChange, onClose]);
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, hasUnsplashEndpoint && /*#__PURE__*/_react.default.createElement(_search_unsplash_result.SearchUnsplashDialog, {
  ...
  })), /*#__PURE__*/_react.default.createElement(_core.DialogContent, null, /*#__PURE__*/_react.default.createElement(UnsplashButton, {
    ...
    onDrop: onDrop
  }), needsFailoverField && /*#__PURE__*/_react.default.createElement(_url_failover_field.URLFailoverField, {
