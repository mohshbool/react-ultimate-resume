...
var ContactInfos = function ContactInfos(_ref) {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(Divider, {
    classes: classes
  }), !isEditing && /*#__PURE__*/_react.default.createElement(ContactInfosRows, {
    contactInformations: contactInformations,
    classes: classes
  }), isEditing && /*#__PURE__*/_react.default.createElement(_edit_contact_infos_button.EditContactInfosButton, {
    contactInformations: contactInformations
  }));
};
...
var ContactInfosRows = function ContactInfosRows(_ref3) {
  ...
  }, Object.entries(contactInformations).filter(function (_ref4) {
    var _CONTACT_INFOS_DATA$c;

    var _ref5 = (0, _slicedToArray2.default)(_ref4, 1),
        contactInformationId = _ref5[0];

    return !((_CONTACT_INFOS_DATA$c = _contact_infos_data.CONTACT_INFOS_DATA[contactInformationId]) === null || _CONTACT_INFOS_DATA$c === void 0 ? void 0 : _CONTACT_INFOS_DATA$c.onlyDialog);
  }).map(function (_ref6) {
    var _ref7 = (0, _slicedToArray2.default)(_ref6, 2),
        contactInformationId = _ref7[0],
        value = _ref7[1];

    return /*#__PURE__*/_react.default.createElement(_contact_info_row.ContactInfoRow, (0, _extends2.default)({
      ...
      return _objectSpread(_objectSpread({}, acc), {}, (0, _defineProperty2.default)({}, key, _contact_infos_data.CONTACT_INFOS_DATA === null || _contact_infos_data.CONTACT_INFOS_DATA === void 0 ? void 0 : (_CONTACT_INFOS_DATA$c2 = _contact_infos_data.CONTACT_INFOS_DATA[contactInformationId]) === null || _CONTACT_INFOS_DATA$c2 === void 0 ? void 0 : _CONTACT_INFOS_DATA$c2[key]));
    }, {})));
  }));
};