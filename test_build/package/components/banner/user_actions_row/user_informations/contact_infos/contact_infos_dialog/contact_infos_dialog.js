...
var ContactInfosDialog = function ContactInfosDialog(_ref) {
  ...
  var fullScreen = (0, _core.useMediaQuery)("(max-width: ".concat(theme === null || theme === void 0 ? void 0 : theme.screenSizes.small, "px)"), {
    defaultMatches: true
  });
  ...
  var handleSave = (0, _react.useCallback)(function () {
    ...
    var edits = Object.entries(inputs).reduce(function (acc, _ref2) {
      ...
      (0, _set.default)(acc, _contact_infos_data.CONTACT_INFOS_DATA === null || _contact_infos_data.CONTACT_INFOS_DATA === void 0 ? void 0 : (_CONTACT_INFOS_DATA$c = _contact_infos_data.CONTACT_INFOS_DATA[contactInformationId]) === null || _CONTACT_INFOS_DATA$c === void 0 ? void 0 : _CONTACT_INFOS_DATA$c.path, value);
      return acc;
    }, {});
    onEdit(edits);
    onClose();
