...
var UserInformations = function UserInformations() {
  ...
  var contactInformations = (0, _react.useMemo)(function () {
    return Object.entries(_contact_infos_data.CONTACT_INFOS_DATA).reduce(function (acc, _ref) {
      var _ref2 = (0, _slicedToArray2.default)(_ref, 2),
          key = _ref2[0],
          path = _ref2[1].path;

      return _objectSpread(_objectSpread({}, acc), {}, (0, _defineProperty2.default)({}, key, (0, _lodash.get)(data, path)));
    }, {});
  }, [data]);
  var hasContactInformations = (0, _react.useMemo)(function () {
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    component: "h4"
  }, (_data$basics3 = data.basics) === null || _data$basics3 === void 0 ? void 0 : _data$basics3.summary), showContactInformations && (isEditing || hasContactInformations) && /*#__PURE__*/_react.default.createElement(_contact_infos.ContactInfos, {
