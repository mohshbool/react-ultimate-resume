...
var CurrentJobIssuesFieldComponent = function CurrentJobIssuesFieldComponent(_ref) {
  ...
  var checkedCurrentJobIssues = (0, _react.useMemo)(function () {
    return Object.entries(currentJobIssues || {}).filter(function (_ref2) {
  ...
  }, _objectSpread(_objectSpread({}, _current_job_issues_field_spring_props.CURRENT_JOB_ISSUES_FIELD_OTHER_TEXTFIELD_TRANSITIONS_SPRING_PROPS), {}, {
    unique: true
  }));
  var handleCheckboxGroupChange = (0, _react.useCallback)(function (newCurrentJobIssues) {
    return onChange(_objectSpread(_objectSpread({}, newCurrentJobIssues.reduce(function (acc, issue) {
      acc[issue] = true;
      return acc;
  ...
  var toggleOtherCurrentJobIssue = (0, _react.useCallback)(function () {
    return setFieldValue("currentJobIssues.".concat(_job_issues_utils.JobIssues.OTHER), typeof currentJobIssues[_job_issues_utils.JobIssues.OTHER] === 'string' ? null : '');
  }, [currentJobIssues]);
