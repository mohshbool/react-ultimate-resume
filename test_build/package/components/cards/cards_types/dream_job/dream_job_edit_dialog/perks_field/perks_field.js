...
var PerksFieldComponent = function PerksFieldComponent(_ref) {
  ...
  }, _objectSpread(_objectSpread({}, _perks_field_transitions_spring_props.PERKS_FIELD_OTHER_TEXTFIELD_TRANSITIONS_SPRING_PROPS), {}, {
    unique: true
  }));
  var handleCheckboxGroupChange = (0, _react.useCallback)(function (newPerks) {
    return onChange(_objectSpread(_objectSpread({}, newPerks.reduce(function (acc, perk) {
      acc[perk] = true;
      return acc;
  ...
  var toggleOtherPerk = (0, _react.useCallback)(function () {
    return setFieldValue("perks.".concat(_job_perks_utils.JobPerks.OTHER), typeof perks[_job_perks_utils.JobPerks.OTHER] === 'string' ? null : '');
  }, [perks]);
